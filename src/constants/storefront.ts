...
export const reviews = [
  {
    ...
    feedback:
      "Kollimalai Arasan products are the perfect balance of taste and health. Healthy, tasty, and made with care. These products never disappoint. Every bite feels homemade and fresh!",
    bg: "--red-50",
  },
  {
    id: 2,
