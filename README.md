...
```env
DATABASE_URL="mysql://root:password@localhost:3306/kollimalai_arasan"
...
```bash
# Create the database
mysql -u root -p -e "CREATE DATABASE kollimalai_arasan"
...
| Staff    | staff@kollimalaiarasan.com   | staff123    |
